...
server = function(input, output,session) {
  ...
  #---print1--univariate----page------------
  observeEvent(input$print1, {
    js$winprint()
  }) 
  ...
  #   textInput(inputId = "referenceinsert", 
  #             label = "Enter new link","")
  # })
  # 
  # observeEvent(input$referencebutton, {
  # d1<-data.frame(S.No=(length(d)+1),link=input$referenceinsert)
  # d2<-rbind(d,d1)
  #  
  # })
